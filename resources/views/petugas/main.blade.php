...
@section('content')
                        ...
                        <table class="table" id="project-status">
                            <thead> 
                                <tr> 
                                    ...
                                    <th> <span class="f-light f-w-600">Nama Petugas</span></th>
                                    ...
                                    <tr class="product-removes">
                                        ...
                                        <td> 
                                            <div class="product-action">
                                                <a href="#" class="me-3 edit-admin" data-bs-toggle="modal" data-bs-target="#modalEdit{{ $item->id_petugas }}" data-whatever="@getbootstrap"><i class="fa fa-pencil-square-o" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit"></i></a>
                                                <a class="delete-item" href="/pengguna/petugas/hapus/{{ $item->pengguna_id }}"><i class="fa fa-trash-o text-danger"  data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Hapus"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    {{-- Modal Edit --}}
                                    <div class="modal fade" id="modalEdit{{ $item->id_petugas }}" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalgetbootstrap" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-toggle-wrapper social-profile text-start dark-sign-up">
                                                    <h3 class="modal-header justify-content-center border-0">Mengubah Petugas</h3>
                                                    <div class="modal-body p-4">
                                                        <form action="/pengguna/petugas/edit/{{ $item->pengguna_id }}" method="post" class="row g-3 needs-validation" novalidate="">
                                                            @csrf
                                                            ...
                                                            <div class="col-md-12 mb-3">
                                                                ...
                                                                <input class="form-control" id="validationCustom03" type="text" name="nama_petugas" placeholder="Masukan nama lengkap" value="{{ $item->nama_petugas }}" required='true'>
                                                                <div class="valid-feedback">Looks good!</div>
                                                            </div>
                                                            <div class="col-md-12 mb-3">
    ...
    <div class="modal fade" id="exampleModalgetbootstrap" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalgetbootstrap" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-toggle-wrapper social-profile text-start dark-sign-up">
                    <h3 class="modal-header justify-content-center border-0">Menambahkan Petugas</h3>
                    <div class="modal-body p-4">
                        <form action="/pengguna/petugas/add" method="post" class="row g-3 needs-validation" novalidate>
                            @csrf
                            <h6 class="">Akun</h6>
                            <div class="col-md-12">
                                <label class="form-label" for="validationCustom01">Username</label>
                            ...
                            <div class="col-md-12">
                                <label class="form-label" for="validationCustom03">Nama Lengkap</label>
                                <input class="form-control" id="validationCustom03" type="text" name="nama_petugas" placeholder="Masukan nama lengkap" required="">
                                <div class="valid-feedback">Looks good!</div>
                            </div>
                            <div class="col-md-12">
                                <label class="form-label" for="validationCustom04">No Telepon</label>
