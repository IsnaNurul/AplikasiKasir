        ...
        <div class="container-fluid">
            <div class="row widget-grid">
                            ...
                            <div class="media media-wrapper justify-content-between">
                                <div class="media-body">
                                    <div class="greeting-user">
                                        <h4 class="f-w-600">Welcome back, {{ auth()->user()->username }}</h4>
                            ...
                            <div class="card widget-1">
                                <div class="card-body">
                                    <div class="widget-content">
                                        ...
                                        <div>
                                            <h4>{{ number_format($total_penjualan), 0, ',', '.' }}</h4><span
                                                class="f-light">Total Penjualan</span>
                                        </div>
                                    </div>
                                    <div class="font-secondary f-w-500"><i
                                            class="{{ $arrow_class }} icon-rotate me-1"></i><span>{{ number_format($persentase_perubahan) }}%</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <div class="card widget-1">
                                    <div class="card-body">
                                        <div class="widget-content">
                                            ...
                                            <div>
                                                <h4>{{ number_format($total_penjualan_thismonth), 0, ',', '.' }}</h4><span
                                                    class="f-light">Penjualan Bulan Ini</span>
                                            </div>
                                        </div>
                            ...
                            <div class="card widget-1">
                                <div class="card-body">
                                    <div class="widget-content">
                                        ...
                                        <div>
                                            <h4>{{ $total_produk_today }}</h4><span class="f-light">Produk Terjual</span>
                                        </div>
                                    </div>
                                ...
                                <div class="card widget-1">
                                    <div class="card-body">
                                        <div class="widget-content">
                                            ...
                                            <div>
                                                <h4>{{ $transaksi }}</h4><span class="f-light">Jumlah Penjualan</span>
                                            </div>
                                        </div>
                        ...
                        <div class="card widget-1">
                            <div class="card-body">
                                <div class="widget-content">
                                    ...
                                    <div>
                                        <h4>{{ number_format($rata_rata_penjualan_hari_ini), 0, ',', '.' }}</h4><span
                                            class="f-light">Rata Rata Penjualan Hari Ini</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card widget-1">
                            <div class="card-body">
                                <div class="widget-content">
                                    ...
                                    <div>
                                        <h4>{{ number_format($rata_rata_penjualan_bulan_ini), 0, ',', '.' }}</h4><span
                                            class="f-light">Rata Rata Penjualan Bulan Ini</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xxl-5 col-md-7 box-col-7">
                    <div class="row">
                        <div class="col-6"> 
                            <div class="card small-widget"> 
                              <div class="card-body primary"><span class="f-light">Total Petugas</span>
                    ...
                    <div class="row">
                        <div class="col-xxl-12 col-xl-12 col-md-6 custom-rs-6 box-col-12">
                            <div class="card trending-card height-equal">
                                <div class="card-header card-no-border">
                                    <div class="header-top">
                                        <h5 class="m-0">Top 3 Produk</h5>
                                        {{-- <div class="card-header-right-icon"><a href="#">View</a></div> --}}
                                    </div>
                                </div>
                                    ...
                                    <div class="appointment-table customer-table table-responsive">
                                        <table class="table table-bordernone">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img class="img-fluid img-40 rounded-circle me-2"
                                                            src="{{ asset('storage/' . $data->produk->gambar_produk) }}" alt="building">
                                                    </td>
                                                    ...
                                                    <td class="text-end">
                                                        ...
                                                        <span class="d-block f-light">{{ $data->produk->nama_kategori }}</span>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                ...
                <div class="col-xxl-7 col-xl-8 box-col-12">
                    <div class="card recent-order">
                        <div class="card-header card-no-border">
                            <div class="header-top">
                                <h5 class="m-0">Penjualan Terbaru</h5>
                            </div>
                        </div>
                                                ...
                                                <tbody>
                                                    @foreach ($recent_order as $item)
                                                        <tr>
                                                                ...
                                                                <div class="product-content">
                                                                    <div>
                                                                        <h6 class="f-14 mb-0"><a
                                                                                href="order-history.html">{{ $item->produk->nama_produk }}</a>
                                                                        </h6><span class="f-light f-12">Id :
                                                                            #{{ $item['penjualan_id'] }}</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="f-w-500">X{{ $item->jumlah_produk }}</td>
                                                            <td class="f-w-500">
                                                                {{ $item->harga_jual / $item->jumlah_produk }}</td>
                                                            <td class="f-w-500">
                                                            ...
                                                            <td class="f-w-500">{{ $item->harga_jual }}</td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
            ...
            <div class="row widget-grid">
                            ...
                            <div class="card widget-1">
                                <div class="card-body">
                                    <div class="widget-content">
                                        ...
                                        <div>
                                            <h4>{{ number_format($total_penjualan_today), 0, ',', '.' }}</h4><span
                                                class="f-light">Penjualan Hari ini</span>
                                        </div>
                                    </div>
                                    <div class="font-secondary f-w-500"><i
                                            class="{{ $arrow_class }} icon-rotate me-1"></i><span>{{ number_format($persentase_perubahan) }}%</span>
                                ...
                                <div class="card-header-right-icon">
                                    <div class="dropdown">
                                        <button class="btn dropdown-toggle" id="dropdownschedules" type="button"
                                            data-bs-toggle="dropdown" aria-expanded="false">Today</button>
                                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownschedules">
                                            <a class="dropdown-item" href="#">Today</a><a class="dropdown-item"
                                                href="#">Tomorrow</a><a class="dropdown-item"
                                                href="#">Yesterday</a>
                                        </div>
                ...
                <div class="col-xxl-5 col-lg-8 col-md-11 box-col-8 col-ed-6">
                    <div class="card papernote-wrap">
                        <div class="card-header card-no-border">
                            <div class="header-top">
                                <h5>PaperNote</h5><a class="f-light d-flex align-items-center" href="#">View project
                                    <i class="f-w-700 icon-arrow-top-right"></i></a>
                            </div>
                        </div>
                        <div class="card-body pt-0"> <img class="banner-img img-fluid"
                            ...
                            <div class="note-content mt-sm-4 mt-2">
                                ...
                                <div class="note-labels">
                                    ...
                                    <div class="last-label"> <span class="badge badge-light-success">Inprogress</span>
                                    </div>
                                </div>
