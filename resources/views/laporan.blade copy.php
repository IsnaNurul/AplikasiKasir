                ...
                <div class="card">
                    <div class="card-body">
                        <div class="list-product-header">
                            <form id="filterForm" action="/laporan-penjualan/filterDate" method="get">
                                <div class="row mb-3">
                                    <div class="col">
                                    ...
                                    <div class="col mt-4">
                                        ...
                                        <button type="submit" onclick="validateForm()"
                                            class="btn btn-primary float-middle float-end mt-n1">Terapkan</button>
                                        @php
                                        ...
                                        <a href="{{ route('laporan-penjualan.export-excel', ['start_date' => $defaultStartDate, 'end_date' => $defaultEndDate]) }}"
                                            class="btn btn-secondary float-middle float-end mt-n1 ms-2">Export Excel</a>
                                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered " id="project-status">
                                <thead style="background-color:#828bec">
                                    <tr>
                                        ...
                                        <th> <span class="text-white f-w-600">Action</span></th>
                                    </tr>
                                </thead>
                                <tbody>
                                            ...
                                            <tr>
                                                @if ($index === 0)
                                                    ...
                                                    <td rowspan="{{ $produkCount }}" style="width: 15%">
                                                        ...
                                                        {{ $item->metode_pembayaran }},<br> {{ $item->pengguna->username }}
                                                    </td>
                                                    <td rowspan="{{ $produkCount }}">
...
@section('script')
    <script>
        function validateForm() {
            ...
            if (diffInDays > 30) {
                alert('Hanya dapat melakukan filter maksimal 1 bulan.');
            } else {
