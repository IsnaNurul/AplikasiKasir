                                    ...
                                    <tr class="product-removes">
                                        ...
                                        <td> 
                                            <div class="product-action">
                                                <a href="#" class="me-3 edit-admin" data-bs-toggle="modal" data-bs-target="#modalEdit{{ $item->id_detail_beli }}" data-whatever="@getbootstrap"><i class="fa fa-pencil-square-o" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit"></i></a>
                                                <a class="hapus-item" href="/pembelian/detail/hapus/{{ $item->id_detail_beli }}"><i class="fa fa-trash-o text-danger"  data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Hapus"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    {{-- Modal Edit --}}
                                    <div class="modal fade" id="modalEdit{{ $item->id_detail_beli }}" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalgetbootstrap" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-toggle-wrapper social-profile text-start dark-sign-up">
                                                    ...
                                                    <div class="modal-body p-4">
                                                        <div class="row">
                                                            <form action="/pembelian/detail/edit/{{ $item->id_detail_beli }}" method="post" class="row g-3 needs-validation" novalidate>
                                                                @csrf
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <select class="form-select" name="produk_kode" id="" required="">
                                                                        ...
                                                                        @foreach ($produk as $value)
                                                                            <option value="{{ $value->kode_produk }}" {{ $item->produk_kode == $value->kode_produk ? 'selected' : '' }}>{{ $value->kode_produk . ' - ' . $value->nama_produk }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                ...
                                                                <div class="col-md-8 mb-3">
                                                                    ...
                                                                    <input class="form-control" id="validationCustom01" type="number" name="harga" value="{{ $item->harga }}" placeholder="Masukan harga produk" required="">
                                                                    <div class="valid-feedback">Looks good!</div>
                                                                </div>
                                                                <div class="col-md-4 mb-3">
                                                                    <label class="form-label" for="validationCustom02">Jumlah</label>
                                                                    <input class="form-control" id="validationCustom02" type="text" name="jumlah_beli" value="{{ $item->jumlah_beli }}"  placeholder="Masukan nama produk" required="">
                                                                    <div class="valid-feedback">Looks good!</div>
                                                                </div>
