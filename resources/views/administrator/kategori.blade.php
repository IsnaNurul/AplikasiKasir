                            ...
                            <table class="table" id="project-status">
                                ...
                                <tbody>
                                    @foreach ($kategori as $key => $item)
                                                ...
                                                <p class="f-light">
                                                    @php
                                                        ...
                                                        foreach ($produk as $diskon) {
                                                            if (
                                                                $diskon->kategori_produk_id == $item->id_kategori_produk
                                                            ) {
                                                                $statusDiskon = true;
                                                                break;
                                                            }
                                            ...
                                            <td>
                                                <div class="product-action">
                                                    <a href="#" class="me-3 edit-admin" data-bs-toggle="modal"
                                                        data-bs-target="#modalEdit{{ $item->id_kategori_produk }}"
                                                        data-whatever="@getbootstrap"><i class="fa fa-pencil-square-o"
                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                            data-bs-title="Edit"></i></a>
                                                    @if ($statusDiskon == true)
                                                        <a class="hapus-item disabled" href="#"
                                                            onclick="return false;"><i class="fa fa-trash-o text-danger"
                                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                                data-bs-title="Hapus"></i></a>
                                                    @else
                                                        <a class="hapus-item"
                                                            href="/kategori-produk/hapus/{{ $item->id_kategori_produk }}"><i
                                        ...
                                        {{-- Modal Edit --}}
                                        <div class="modal fade" id="modalEdit{{ $item->id_kategori_produk }}"
                                            data-bs-backdrop="static" tabindex="-1" role="dialog"
                                            aria-labelledby="exampleModalgetbootstrap" aria-hidden="true" style="top: 0;">
                                                ...
                                                <div class="modal-content">
                                                    <div
                                                        ...
                                                        <div class="modal-body p-4">
                                                            <form
                                                                action="/kategori-produk/edit/{{ $item->id_kategori_produk }}"
                                                                method="post" class="row g-3 needs-validation" novalidate>
                                                                @csrf
                                                                <div class="col-md-12 mb-3">
                                                                    <label class="form-label" for="validationCustom01">Nama
                                                                        Kategori</label>
